...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_cipheringDisabled_r16_constr_26 CC_NOTUSED = {
...
static const asn_INTEGER_enum_map_t asn_MAP_cipheringDisabled_r16_value2enum_26[] = {
	{ 0,	4,	"true" }
};
static const unsigned int asn_MAP_cipheringDisabled_r16_enum2value_26[] = {
	0	/* true(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_cipheringDisabled_r16_specs_26 = {
	asn_MAP_cipheringDisabled_r16_value2enum_26,	/* "tag" => N; sorted by tag */
	asn_MAP_cipheringDisabled_r16_enum2value_26,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_cipheringDisabled_r16_tags_26[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_cipheringDisabled_r16_26 = {
	"cipheringDisabled-r16",
	"cipheringDisabled-r16",
	&asn_OP_NativeEnumerated,
	asn_DEF_cipheringDisabled_r16_tags_26,
	sizeof(asn_DEF_cipheringDisabled_r16_tags_26)
		/sizeof(asn_DEF_cipheringDisabled_r16_tags_26[0]) - 1, /* 1 */
	asn_DEF_cipheringDisabled_r16_tags_26,	/* Same as above */
	sizeof(asn_DEF_cipheringDisabled_r16_tags_26)
		/sizeof(asn_DEF_cipheringDisabled_r16_tags_26[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_cipheringDisabled_r16_constr_26,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	0, 0,	/* Defined elsewhere */
	&asn_SPC_cipheringDisabled_r16_specs_26	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext1_25[] = {
	{ ATF_POINTER, 1, offsetof(struct PDCP_Config_NB_r13__ext1, cipheringDisabled_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_cipheringDisabled_r16_26,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_25 = {
	sizeof(struct PDCP_Config_NB_r13__ext1),
	offsetof(struct PDCP_Config_NB_r13__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_PDCP_Config_NB_r13_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct PDCP_Config_NB_r13, ext1),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_ext1_25,
		0,
...
static const int asn_MAP_PDCP_Config_NB_r13_oms_1[] = { 0, 2 };
