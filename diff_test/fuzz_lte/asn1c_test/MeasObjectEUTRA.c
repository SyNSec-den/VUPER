...
static asn_TYPE_member_t asn_MBR_ext7_45[] = {
	{ ATF_POINTER, 1, offsetof(struct MeasObjectEUTRA__ext7, measRSS_DedicatedConfig_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_SetupRelease_MeasRSS_DedicatedConfig_r16,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
asn_TYPE_member_t asn_MBR_MeasObjectEUTRA_1[] = {
	...
	{ ATF_POINTER, 10, offsetof(struct MeasObjectEUTRA, blackCellsToRemoveList),
	...
	{ ATF_POINTER, 9, offsetof(struct MeasObjectEUTRA, blackCellsToAddModList),
