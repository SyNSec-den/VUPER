...
static asn_TYPE_member_t asn_MBR_ext2_12[] = {
	{ ATF_POINTER, 1, offsetof(struct SystemInformationBlockType14_NB_r13__ext2, uac_Param_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
...
static asn_SEQUENCE_specifics_t asn_SPC_ext2_specs_12 = {
	sizeof(struct SystemInformationBlockType14_NB_r13__ext2),
	offsetof(struct SystemInformationBlockType14_NB_r13__ext2, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_SystemInformationBlockType14_NB_r13_1[] = {
	{ ATF_POINTER, 4, offsetof(struct SystemInformationBlockType14_NB_r13, ab_Param_r13),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		+1,	/* EXPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct SystemInformationBlockType14_NB_r13, lateNonCriticalExtension),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct SystemInformationBlockType14_NB_r13, ext1),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_ext1_8,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct SystemInformationBlockType14_NB_r13, ext2),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_ext2_12,
		0,
...
static const int asn_MAP_SystemInformationBlockType14_NB_r13_oms_1[] = { 0, 1, 2, 3 };
