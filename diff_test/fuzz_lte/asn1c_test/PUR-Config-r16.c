...
static asn_jer_constraints_t asn_JER_memb_hsfn_LSB_Info_r16_constr_12 CC_NOTUSED = {
	1};
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
			&asn_JER_memb_hsfn_LSB_Info_r16_constr_12,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_pur_ResponseWindowTimer_r16_constr_19,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
...
asn_TYPE_member_t asn_MBR_PUR_Config_r16_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct PUR_Config_r16, pur_RSRP_ChangeThreshold_r16),
		...
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_SetupRelease_PUR_RSRP_ChangeThreshold_r16,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
	...
	{ ATF_POINTER, 2, offsetof(struct PUR_Config_r16, pur_PUCCH_Config_r16),
	...
	{ ATF_POINTER, 1, offsetof(struct PUR_Config_r16, pur_PUSCH_Config_r16),
...
static const int asn_MAP_PUR_Config_r16_oms_1[] = { 0, 1, 2, 4, 5, 6, 7, 8, 10, 11 };
