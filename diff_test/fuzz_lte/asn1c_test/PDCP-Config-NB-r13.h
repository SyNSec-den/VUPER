...
typedef enum PDCP_Config_NB_r13__ext1__cipheringDisabled_r16 {
	PDCP_Config_NB_r13__ext1__cipheringDisabled_r16_true	= 0
} e_PDCP_Config_NB_r13__ext1__cipheringDisabled_r16;
...
typedef struct PDCP_Config_NB_r13 {
	 ...
	 * possible extensions are below.
	 */
	struct PDCP_Config_NB_r13__ext1 {
...
/* extern asn_TYPE_descriptor_t asn_DEF_cipheringDisabled_r16_26;	// (Use -fall-defs-global to expose) */
...
extern asn_TYPE_member_t asn_MBR_PDCP_Config_NB_r13_1[3];
