...
static asn_jer_constraints_t asn_JER_memb_spare_constr_8 CC_NOTUSED = {
	3};
...
asn_TYPE_member_t asn_MBR_RRCConnectionResumeRequest_NB_r13_IEs_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RRCConnectionResumeRequest_NB_r13_IEs, anr_InfoAvailable_r16),
