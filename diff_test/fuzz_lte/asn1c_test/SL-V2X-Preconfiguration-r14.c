...
static asn_TYPE_member_t asn_MBR_ext2_12[] = {
	{ ATF_POINTER, 1, offsetof(struct SL_V2X_Preconfiguration_r14__ext2, anchorCarrierFreqListNR_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_ext2_specs_12 = {
	sizeof(struct SL_V2X_Preconfiguration_r14__ext2),
	offsetof(struct SL_V2X_Preconfiguration_r14__ext2, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_SL_V2X_Preconfiguration_r14_1[] = {
	...
	{ ATF_POINTER, 4, offsetof(struct SL_V2X_Preconfiguration_r14, anchorCarrierFreqList_r14),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct SL_V2X_Preconfiguration_r14, cbr_PreconfigList_r14),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct SL_V2X_Preconfiguration_r14, ext1),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_ext1_6,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct SL_V2X_Preconfiguration_r14, ext2),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext2_12,
		0,
...
static const int asn_MAP_SL_V2X_Preconfiguration_r14_oms_1[] = { 1, 2, 3, 4 };
