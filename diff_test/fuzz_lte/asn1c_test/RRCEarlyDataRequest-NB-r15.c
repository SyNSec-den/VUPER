...
static asn_SEQUENCE_specifics_t asn_SPC_criticalExtensionsFuture_specs_6 = {
	sizeof(struct RRCEarlyDataRequest_NB_r15__criticalExtensions__later__criticalExtensionsFuture),
	offsetof(struct RRCEarlyDataRequest_NB_r15__criticalExtensions__later__criticalExtensionsFuture, _asn_ctx),
	0,	/* No top level tags */
...
static asn_TYPE_member_t asn_MBR_later_4[] = {
	{ ATF_POINTER, 0, offsetof(struct RRCEarlyDataRequest_NB_r15__criticalExtensions__later, choice.rrcEarlyDataRequest_r16),
	...
	{ ATF_POINTER, 0, offsetof(struct RRCEarlyDataRequest_NB_r15__criticalExtensions__later, choice.criticalExtensionsFuture),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
...
static asn_CHOICE_specifics_t asn_SPC_later_specs_4 = {
	sizeof(struct RRCEarlyDataRequest_NB_r15__criticalExtensions__later),
	offsetof(struct RRCEarlyDataRequest_NB_r15__criticalExtensions__later, _asn_ctx),
	offsetof(struct RRCEarlyDataRequest_NB_r15__criticalExtensions__later, present),
	sizeof(((struct RRCEarlyDataRequest_NB_r15__criticalExtensions__later *)0)->present),
...
static asn_TYPE_member_t asn_MBR_criticalExtensions_2[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct RRCEarlyDataRequest_NB_r15__criticalExtensions, choice.later),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
