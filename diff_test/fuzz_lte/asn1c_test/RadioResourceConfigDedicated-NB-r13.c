...
static asn_TYPE_member_t asn_MBR_ext2_13[] = {
	{ ATF_POINTER, 1, offsetof(struct RadioResourceConfigDedicated_NB_r13__ext2, newUE_Identity_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_C_RNTI,
		0,
...
static asn_SEQUENCE_specifics_t asn_SPC_ext2_specs_13 = {
	sizeof(struct RadioResourceConfigDedicated_NB_r13__ext2),
	offsetof(struct RadioResourceConfigDedicated_NB_r13__ext2, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_RadioResourceConfigDedicated_NB_r13_1[] = {
	{ ATF_POINTER, 8, offsetof(struct RadioResourceConfigDedicated_NB_r13, srb_ToAddModList_r13),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 7, offsetof(struct RadioResourceConfigDedicated_NB_r13, drb_ToAddModList_r13),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 6, offsetof(struct RadioResourceConfigDedicated_NB_r13, drb_ToReleaseList_r13),
	...
	{ ATF_POINTER, 5, offsetof(struct RadioResourceConfigDedicated_NB_r13, mac_MainConfig_r13),
	...
	{ ATF_POINTER, 4, offsetof(struct RadioResourceConfigDedicated_NB_r13, physicalConfigDedicated_r13),
	...
	{ ATF_POINTER, 3, offsetof(struct RadioResourceConfigDedicated_NB_r13, rlf_TimersAndConstants_r13),
	...
	{ ATF_POINTER, 2, offsetof(struct RadioResourceConfigDedicated_NB_r13, ext1),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_ext1_11,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct RadioResourceConfigDedicated_NB_r13, ext2),
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		0,
		&asn_DEF_ext2_13,
		0,
...
static const int asn_MAP_RadioResourceConfigDedicated_NB_r13_oms_1[] = { 0, 1, 2, 3, 4, 5, 6, 7 };
