...
static asn_TYPE_member_t asn_MBR_ext2_11[] = {
	{ ATF_POINTER, 1, offsetof(struct DRB_ToAddMod_NB_r13__ext2, pdu_Session_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_ext2_specs_11 = {
	sizeof(struct DRB_ToAddMod_NB_r13__ext2),
	offsetof(struct DRB_ToAddMod_NB_r13__ext2, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_DRB_ToAddMod_NB_r13_1[] = {
	...
	{ ATF_POINTER, 6, offsetof(struct DRB_ToAddMod_NB_r13, pdcp_Config_r13),
	...
	{ ATF_POINTER, 5, offsetof(struct DRB_ToAddMod_NB_r13, rlc_Config_r13),
	...
	{ ATF_POINTER, 4, offsetof(struct DRB_ToAddMod_NB_r13, logicalChannelIdentity_r13),
	...
	{ ATF_POINTER, 3, offsetof(struct DRB_ToAddMod_NB_r13, logicalChannelConfig_r13),
	...
	{ ATF_POINTER, 2, offsetof(struct DRB_ToAddMod_NB_r13, ext1),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_ext1_9,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct DRB_ToAddMod_NB_r13, ext2),
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		0,
		&asn_DEF_ext2_11,
		0,
...
static const int asn_MAP_DRB_ToAddMod_NB_r13_oms_1[] = { 0, 2, 3, 4, 5, 6, 7 };
