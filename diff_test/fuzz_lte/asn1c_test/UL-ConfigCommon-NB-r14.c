...
static asn_TYPE_member_t asn_MBR_ext2_7[] = {
	{ ATF_POINTER, 1, offsetof(struct UL_ConfigCommon_NB_r14__ext2, rsrp_ThresholdsPrachInfoList_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_ext2_specs_7 = {
	sizeof(struct UL_ConfigCommon_NB_r14__ext2),
	offsetof(struct UL_ConfigCommon_NB_r14__ext2, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_UL_ConfigCommon_NB_r14_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct UL_ConfigCommon_NB_r14, nprach_ParametersList_r14),
	...
	{ ATF_POINTER, 2, offsetof(struct UL_ConfigCommon_NB_r14, ext1),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_ext1_5,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct UL_ConfigCommon_NB_r14, ext2),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_ext2_7,
		0,
...
static const int asn_MAP_UL_ConfigCommon_NB_r14_oms_1[] = { 1, 2, 3 };
