...
asn_TYPE_member_t asn_MBR_RS_ConfigSSB_NR_r15_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct RS_ConfigSSB_NR_r15, ext1),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_ext1_9,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct RS_ConfigSSB_NR_r15, ext2),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_ext2_13,
		0,
...
static const int asn_MAP_RS_ConfigSSB_NR_r15_oms_1[] = { 2, 3 };
