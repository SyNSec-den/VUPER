...
asn_TYPE_member_t asn_MBR_RAN_NotificationAreaInfo_r15_1[] = {
	{ ATF_POINTER, 0, offsetof(struct RAN_NotificationAreaInfo_r15, choice.cellList),
	...
	{ ATF_POINTER, 0, offsetof(struct RAN_NotificationAreaInfo_r15, choice.ran_AreaConfigList),
