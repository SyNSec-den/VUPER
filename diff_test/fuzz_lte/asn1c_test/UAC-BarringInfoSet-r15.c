...
static asn_jer_constraints_t asn_JER_memb_uac_BarringForAccessIdentity_r15_constr_28 CC_NOTUSED = {
	7};
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
			&asn_JER_memb_uac_BarringForAccessIdentity_r15_constr_28,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
