...
static asn_TYPE_member_t asn_MBR_ext5_18[] = {
	{ ATF_POINTER, 4, offsetof(struct PhysicalConfigDedicated_NB_r13__ext5, npusch_ConfigDedicated_v1610),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct PhysicalConfigDedicated_NB_r13__ext5, npdsch_ConfigDedicated_r16),
	...
	{ ATF_POINTER, 2, offsetof(struct PhysicalConfigDedicated_NB_r13__ext5, resourceReservationConfigDL_r16),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_SetupRelease_ResourceReservationConfig_NB_r16,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
	...
	{ ATF_POINTER, 1, offsetof(struct PhysicalConfigDedicated_NB_r13__ext5, resourceReservationConfigUL_r16),
...
static const int asn_MAP_ext5_oms_18[] = { 0, 1, 2, 3 };
...
static asn_SEQUENCE_specifics_t asn_SPC_ext5_specs_18 = {
	sizeof(struct PhysicalConfigDedicated_NB_r13__ext5),
	offsetof(struct PhysicalConfigDedicated_NB_r13__ext5, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_PhysicalConfigDedicated_NB_r13_1[] = {
	{ ATF_POINTER, 9, offsetof(struct PhysicalConfigDedicated_NB_r13, carrierConfigDedicated_r13),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 8, offsetof(struct PhysicalConfigDedicated_NB_r13, npdcch_ConfigDedicated_r13),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 7, offsetof(struct PhysicalConfigDedicated_NB_r13, npusch_ConfigDedicated_r13),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 6, offsetof(struct PhysicalConfigDedicated_NB_r13, uplinkPowerControlDedicated_r13),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 5, offsetof(struct PhysicalConfigDedicated_NB_r13, ext1),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext1_7,
		0,
	...
	{ ATF_POINTER, 4, offsetof(struct PhysicalConfigDedicated_NB_r13, ext2),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_ext2_10,
		0,
	...
	{ ATF_POINTER, 3, offsetof(struct PhysicalConfigDedicated_NB_r13, ext3),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_ext3_13,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct PhysicalConfigDedicated_NB_r13, ext4),
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		0,
		&asn_DEF_ext4_15,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct PhysicalConfigDedicated_NB_r13, ext5),
		(ASN_TAG_CLASS_CONTEXT | (8 << 2)),
		0,
		&asn_DEF_ext5_18,
		0,
...
static const int asn_MAP_PhysicalConfigDedicated_NB_r13_oms_1[] = { 0, 1, 2, 3, 4, 5, 6, 7, 8 };
