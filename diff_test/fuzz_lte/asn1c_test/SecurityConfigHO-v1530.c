...
static asn_TYPE_member_t asn_MBR_handoverType_v1530_2[] = {
	{ ATF_POINTER, 0, offsetof(struct SecurityConfigHO_v1530__handoverType_v1530, choice.intra5GC),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_intra5GC_3,
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct SecurityConfigHO_v1530__handoverType_v1530, choice.fivegc_ToEPC),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct SecurityConfigHO_v1530__handoverType_v1530, choice.epc_To5GC),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
