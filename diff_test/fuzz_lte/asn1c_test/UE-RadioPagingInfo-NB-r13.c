...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_ue_Category_NB_r16_constr_21 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_groupWakeUpSignal_r16_constr_23 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_groupWakeUpSignalAlternation_r16_constr_25 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 0,  0,  0,  0 }	/* (0..0) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static const asn_INTEGER_enum_map_t asn_MAP_ue_Category_NB_r16_value2enum_21[] = {
	{ 0,	3,	"nb2" }
};
static const unsigned int asn_MAP_ue_Category_NB_r16_enum2value_21[] = {
	0	/* nb2(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_ue_Category_NB_r16_specs_21 = {
	asn_MAP_ue_Category_NB_r16_value2enum_21,	/* "tag" => N; sorted by tag */
	asn_MAP_ue_Category_NB_r16_enum2value_21,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_ue_Category_NB_r16_tags_21[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_ue_Category_NB_r16_21 = {
	"ue-Category-NB-r16",
	"ue-Category-NB-r16",
	&asn_OP_NativeEnumerated,
	asn_DEF_ue_Category_NB_r16_tags_21,
	sizeof(asn_DEF_ue_Category_NB_r16_tags_21)
		/sizeof(asn_DEF_ue_Category_NB_r16_tags_21[0]) - 1, /* 1 */
	asn_DEF_ue_Category_NB_r16_tags_21,	/* Same as above */
	sizeof(asn_DEF_ue_Category_NB_r16_tags_21)
		/sizeof(asn_DEF_ue_Category_NB_r16_tags_21[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_ue_Category_NB_r16_constr_21,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	0, 0,	/* Defined elsewhere */
	&asn_SPC_ue_Category_NB_r16_specs_21	/* Additional specs */
};

static const asn_INTEGER_enum_map_t asn_MAP_groupWakeUpSignal_r16_value2enum_23[] = {
	{ 0,	4,	"true" }
};
static const unsigned int asn_MAP_groupWakeUpSignal_r16_enum2value_23[] = {
	0	/* true(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_groupWakeUpSignal_r16_specs_23 = {
	asn_MAP_groupWakeUpSignal_r16_value2enum_23,	/* "tag" => N; sorted by tag */
	asn_MAP_groupWakeUpSignal_r16_enum2value_23,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_groupWakeUpSignal_r16_tags_23[] = {
	(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_groupWakeUpSignal_r16_23 = {
	"groupWakeUpSignal-r16",
	"groupWakeUpSignal-r16",
	&asn_OP_NativeEnumerated,
	asn_DEF_groupWakeUpSignal_r16_tags_23,
	sizeof(asn_DEF_groupWakeUpSignal_r16_tags_23)
		/sizeof(asn_DEF_groupWakeUpSignal_r16_tags_23[0]) - 1, /* 1 */
	asn_DEF_groupWakeUpSignal_r16_tags_23,	/* Same as above */
	sizeof(asn_DEF_groupWakeUpSignal_r16_tags_23)
		/sizeof(asn_DEF_groupWakeUpSignal_r16_tags_23[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_groupWakeUpSignal_r16_constr_23,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	0, 0,	/* Defined elsewhere */
	&asn_SPC_groupWakeUpSignal_r16_specs_23	/* Additional specs */
};

static const asn_INTEGER_enum_map_t asn_MAP_groupWakeUpSignalAlternation_r16_value2enum_25[] = {
	{ 0,	4,	"true" }
};
static const unsigned int asn_MAP_groupWakeUpSignalAlternation_r16_enum2value_25[] = {
	0	/* true(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_groupWakeUpSignalAlternation_r16_specs_25 = {
	asn_MAP_groupWakeUpSignalAlternation_r16_value2enum_25,	/* "tag" => N; sorted by tag */
	asn_MAP_groupWakeUpSignalAlternation_r16_enum2value_25,	/* N => "tag"; sorted by N */
	1,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_groupWakeUpSignalAlternation_r16_tags_25[] = {
	(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_groupWakeUpSignalAlternation_r16_25 = {
	"groupWakeUpSignalAlternation-r16",
	"groupWakeUpSignalAlternation-r16",
	&asn_OP_NativeEnumerated,
	asn_DEF_groupWakeUpSignalAlternation_r16_tags_25,
	sizeof(asn_DEF_groupWakeUpSignalAlternation_r16_tags_25)
		/sizeof(asn_DEF_groupWakeUpSignalAlternation_r16_tags_25[0]) - 1, /* 1 */
	asn_DEF_groupWakeUpSignalAlternation_r16_tags_25,	/* Same as above */
	sizeof(asn_DEF_groupWakeUpSignalAlternation_r16_tags_25)
		/sizeof(asn_DEF_groupWakeUpSignalAlternation_r16_tags_25[0]), /* 2 */
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_groupWakeUpSignalAlternation_r16_constr_25,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
	...
	0, 0,	/* Defined elsewhere */
	&asn_SPC_groupWakeUpSignalAlternation_r16_specs_25	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_ext3_20[] = {
	{ ATF_POINTER, 3, offsetof(struct UE_RadioPagingInfo_NB_r13__ext3, ue_Category_NB_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ue_Category_NB_r16_21,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
	...
	{ ATF_POINTER, 2, offsetof(struct UE_RadioPagingInfo_NB_r13__ext3, groupWakeUpSignal_r16),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_groupWakeUpSignal_r16_23,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
	...
	{ ATF_POINTER, 1, offsetof(struct UE_RadioPagingInfo_NB_r13__ext3, groupWakeUpSignalAlternation_r16),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_groupWakeUpSignalAlternation_r16_25,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const int asn_MAP_ext3_oms_20[] = { 0, 1, 2 };
...
static asn_SEQUENCE_specifics_t asn_SPC_ext3_specs_20 = {
	sizeof(struct UE_RadioPagingInfo_NB_r13__ext3),
	offsetof(struct UE_RadioPagingInfo_NB_r13__ext3, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_UE_RadioPagingInfo_NB_r13_1[] = {
	{ ATF_POINTER, 4, offsetof(struct UE_RadioPagingInfo_NB_r13, ue_Category_NB_r13),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct UE_RadioPagingInfo_NB_r13, ext1),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_ext1_5,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct UE_RadioPagingInfo_NB_r13, ext2),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_ext2_8,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct UE_RadioPagingInfo_NB_r13, ext3),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_ext3_20,
		0,
...
static const int asn_MAP_UE_RadioPagingInfo_NB_r13_oms_1[] = { 0, 1, 2, 3 };
