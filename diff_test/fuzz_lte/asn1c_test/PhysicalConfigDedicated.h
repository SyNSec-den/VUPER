...
struct SetupRelease_ResourceReservationConfigDedicatedDL_r16;
struct SetupRelease_ResourceReservationConfigDedicatedUL_r16;
struct SetupRelease_SoundingRS_UL_ConfigDedicatedAdd_r16;
struct SetupRelease_UplinkPowerControlAddSRS_r16;
struct SetupRelease_SoundingRS_VirtualCellID_r16;
struct SetupRelease_WidebandPRG_r16;
...
typedef struct PhysicalConfigDedicated {
	...
	struct PhysicalConfigDedicated__ext13 {
		...
		struct SetupRelease_ResourceReservationConfigDedicatedDL_r16	*resourceReservationConfigDedicatedDL_r16;	/* OPTIONAL */
		struct SetupRelease_ResourceReservationConfigDedicatedUL_r16	*resourceReservationConfigDedicatedUL_r16;	/* OPTIONAL */
		struct SetupRelease_SoundingRS_UL_ConfigDedicatedAdd_r16	*soundingRS_UL_ConfigDedicatedAdd_r16;	/* OPTIONAL */
		struct SetupRelease_UplinkPowerControlAddSRS_r16	*uplinkPowerControlAddSRS_r16;	/* OPTIONAL */
		struct SetupRelease_SoundingRS_VirtualCellID_r16	*soundingRS_VirtualCellID_r16;	/* OPTIONAL */
		struct SetupRelease_WidebandPRG_r16	*widebandPRG_r16;	/* OPTIONAL */
...
extern asn_TYPE_member_t asn_MBR_PhysicalConfigDedicated_1[23];
