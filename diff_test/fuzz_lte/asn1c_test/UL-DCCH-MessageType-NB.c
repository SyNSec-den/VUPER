...
static asn_TYPE_member_t asn_MBR_c1_2[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct UL_DCCH_MessageType_NB__c1, choice.ueInformationResponse_r16),
	...
	{ ATF_POINTER, 0, offsetof(struct UL_DCCH_MessageType_NB__c1, choice.purConfigurationRequest_r16),
