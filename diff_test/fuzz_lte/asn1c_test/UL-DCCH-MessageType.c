...
static asn_TYPE_member_t asn_MBR_c2_20[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct UL_DCCH_MessageType__messageClassExtension__c2, choice.purConfigurationRequest_r16),
		(ASN_TAG_CLASS_CONTEXT | (12 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 0, offsetof(struct UL_DCCH_MessageType__messageClassExtension__c2, choice.failureInformation_r16),
		(ASN_TAG_CLASS_CONTEXT | (13 << 2)),
		-1,	/* IMPLICIT tag at current level */
