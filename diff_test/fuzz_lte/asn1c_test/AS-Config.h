...
struct AS_ConfigNR_v1570;
struct AS_ConfigNR_v1620;
...
typedef struct AS_Config {
	...
	struct AS_Config__ext6 {
		struct AS_ConfigNR_v1570	*as_ConfigNR_v1570;	/* OPTIONAL */
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} *ext6;
	struct AS_Config__ext7 {
		struct AS_ConfigNR_v1620	*as_ConfigNR_v1620;	/* OPTIONAL */
