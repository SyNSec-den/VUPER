...
asn_TYPE_member_t asn_MBR_SystemInformationBlockType25_r15_1[] = {
	...
	{ ATF_POINTER, 4, offsetof(struct SystemInformationBlockType25_r15, uac_AC1_SelectAssistInfo_r15),
	...
	{ ATF_POINTER, 3, offsetof(struct SystemInformationBlockType25_r15, lateNonCriticalExtension),
	...
	{ ATF_POINTER, 2, offsetof(struct SystemInformationBlockType25_r15, ext1),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_ext1_11,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct SystemInformationBlockType25_r15, ext2),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_ext2_17,
		0,
...
static const int asn_MAP_SystemInformationBlockType25_r15_oms_1[] = { 0, 1, 3, 4, 5, 6 };
