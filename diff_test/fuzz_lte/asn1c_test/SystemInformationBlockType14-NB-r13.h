...
typedef struct SystemInformationBlockType14_NB_r13 {
	...
	struct SystemInformationBlockType14_NB_r13__ext2 {
		struct UAC_Param_NB_r16	*uac_Param_r16;	/* OPTIONAL */
...
extern asn_TYPE_member_t asn_MBR_SystemInformationBlockType14_NB_r13_1[4];
