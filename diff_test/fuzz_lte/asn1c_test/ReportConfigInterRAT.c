...
asn_TYPE_member_t asn_MBR_ReportConfigInterRAT_1[] = {
	...
	{ ATF_POINTER, 8, offsetof(struct ReportConfigInterRAT, ext1),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext1_50,
		0,
	...
	{ ATF_POINTER, 7, offsetof(struct ReportConfigInterRAT, ext2),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_ext2_53,
		0,
	...
	{ ATF_POINTER, 6, offsetof(struct ReportConfigInterRAT, ext3),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_ext3_56,
		0,
	...
	{ ATF_POINTER, 5, offsetof(struct ReportConfigInterRAT, ext4),
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		0,
		&asn_DEF_ext4_58,
		0,
	...
	{ ATF_POINTER, 4, offsetof(struct ReportConfigInterRAT, ext5),
		(ASN_TAG_CLASS_CONTEXT | (8 << 2)),
		0,
		&asn_DEF_ext5_62,
		0,
	...
	{ ATF_POINTER, 3, offsetof(struct ReportConfigInterRAT, ext6),
		(ASN_TAG_CLASS_CONTEXT | (9 << 2)),
		0,
		&asn_DEF_ext6_64,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct ReportConfigInterRAT, ext7),
		(ASN_TAG_CLASS_CONTEXT | (10 << 2)),
		0,
		&asn_DEF_ext7_66,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct ReportConfigInterRAT, ext8),
		(ASN_TAG_CLASS_CONTEXT | (11 << 2)),
		0,
		&asn_DEF_ext8_74,
		0,
...
static const int asn_MAP_ReportConfigInterRAT_oms_1[] = { 4, 5, 6, 7, 8, 9, 10, 11 };
