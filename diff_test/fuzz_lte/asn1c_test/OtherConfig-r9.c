...
asn_TYPE_member_t asn_MBR_OtherConfig_r9_1[] = {
	{ ATF_POINTER, 6, offsetof(struct OtherConfig_r9, reportProximityConfig_r9),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 5, offsetof(struct OtherConfig_r9, ext1),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_ext1_4,
		0,
	...
	{ ATF_POINTER, 4, offsetof(struct OtherConfig_r9, ext2),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_ext2_8,
		0,
	...
	{ ATF_POINTER, 3, offsetof(struct OtherConfig_r9, ext3),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_ext3_61,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct OtherConfig_r9, ext4),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_ext4_82,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct OtherConfig_r9, ext5),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_ext5_99,
		0,
...
static const int asn_MAP_OtherConfig_r9_oms_1[] = { 0, 1, 2, 3, 4, 5 };
