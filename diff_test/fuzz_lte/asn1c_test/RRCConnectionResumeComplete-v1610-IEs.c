...
static asn_SEQUENCE_specifics_t asn_SPC_nonCriticalExtension_specs_6 = {
	sizeof(struct RRCConnectionResumeComplete_v1610_IEs__nonCriticalExtension),
	offsetof(struct RRCConnectionResumeComplete_v1610_IEs__nonCriticalExtension, _asn_ctx),
	0,	/* No top level tags */
