...
if True:
    ...
    if True:
        if True:
            ...
            ocaml_result = subprocess.run(["./../../ocaml_test_ul/_build/default/test/test.exe"], input=data, text=False, capture_output=True)
            ...
            ul_dcch = nr_test.NR_RRC_Definitions.UL_DCCH_Message
            ul_dcch.from_uper(data)
            ...
            try:
               ...
               pass
                ...
                if (ocaml_error == 1):
                    ...
                    print("pycrate result is : ", ul_dcch())

                    try:
                        pycrate_dict = (json.loads(ul_dcch.to_jer())['message'])
                    except:
                    
                        pycrate_dict = tuple_to_dict(ul_dcch())
                        pycrate_dict = (json.loads(ul_dcch.to_jer(pycrate_dict))['message'])
                    ...
                    print("its real encoding should be: ", ul_dcch.to_uper().hex())
