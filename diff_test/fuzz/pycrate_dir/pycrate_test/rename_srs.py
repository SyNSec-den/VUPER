        ...
        if isinstance(obj, dict):
            ...
            for k, v in obj.items():
                ...
                # consider the problem with setup release
                    ...
                    if (fmt_k._tr == nr_test.NR_RRC_Definitions.SetupRelease):
...
if (vp_dict == "Error"):
    ...
    if srs_dict == "Error":
        ...
        normed_vp_dict = norm_to_srs_format( vp_dict, nr_test.NR_RRC_Definitions.UL_DCCH_MessageType)
        result = (srs_dict[0]["UL-DCCH-Message"]["message"] == normed_vp_dict)
