...
static asn_jer_constraints_t asn_JER_memb_systemFrameNumber_constr_2 CC_NOTUSED = {
	6};
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
static asn_jer_constraints_t asn_JER_memb_spare_constr_17 CC_NOTUSED = {
	1};
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
			&asn_JER_memb_systemFrameNumber_constr_2,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
