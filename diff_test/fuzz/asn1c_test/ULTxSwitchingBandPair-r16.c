...
static asn_jer_constraints_t asn_JER_memb_uplinkTxSwitching_DL_Interruption_r16_constr_8 CC_NOTUSED = {
	-1};
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
			&asn_JER_memb_uplinkTxSwitching_DL_Interruption_r16_constr_8,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
