...
#ifndef ASNFUZZ_LTE_UPER_H
#define ASNFUZZ_LTE_UPER_H
...
long uper_lte_structure(char *buf_in, long in_len, char *buf_out, long out_max);
...
/// a negative error code on failure.
long uper_lte_destructure(char *buf_in, long in_len, char *buf_out, long out_max);

#ifdef __cplusplus
}
#endif // __cplusplus

#endif // ASNFUZZ_LTE_UPER_H
