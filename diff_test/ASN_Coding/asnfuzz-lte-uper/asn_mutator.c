...
size_t afl_custom_fuzz(my_mutator_t *data, uint8_t *buf, size_t buf_size,
  ...
  long destruct_len = uper_lte_destructure((char*)buf, buf_size, (char *)input_de, INPUT_SIZE);
  ...
  if (destruct_len < 0) {
    ...
    struct_len = uper_lte_structure((char*)input_de, INPUT_SIZE, (char*) data->mutate_out, OUTPUT_SIZE);
    ...
    struct_len = uper_lte_structure((char*) inter_de, inter_len, (char *) data->mutate_out, OUTPUT_SIZE);
  }
