...
asn_TYPE_member_t asn_MBR_SpecialVehicleContainer_1[] = {
	{ ATF_POINTER, 0, offsetof(struct SpecialVehicleContainer, choice.publicTransportContainer),
	...
	{ ATF_POINTER, 0, offsetof(struct SpecialVehicleContainer, choice.specialTransportContainer),
	...
	{ ATF_POINTER, 0, offsetof(struct SpecialVehicleContainer, choice.dangerousGoodsContainer),
	...
	{ ATF_POINTER, 0, offsetof(struct SpecialVehicleContainer, choice.roadWorksContainerBasic),
	...
	{ ATF_POINTER, 0, offsetof(struct SpecialVehicleContainer, choice.rescueContainer),
	...
	{ ATF_POINTER, 0, offsetof(struct SpecialVehicleContainer, choice.emergencyContainer),
	...
	{ ATF_POINTER, 0, offsetof(struct SpecialVehicleContainer, choice.safetyCarContainer),
