...
asn_TYPE_member_t asn_MBR_HighFrequencyContainer_1[] = {
	{ ATF_POINTER, 0, offsetof(struct HighFrequencyContainer, choice.basicVehicleContainerHighFrequency),
	...
	{ ATF_POINTER, 0, offsetof(struct HighFrequencyContainer, choice.rsuContainerHighFrequency),
