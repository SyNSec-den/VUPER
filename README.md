...
> [!IMPORTANT]
> **A Rewrite of VUPER is released as vasn https://github.com/zhouxt1/vasn**. Currently, the rewrite's performance exceeds the open source C/Rust ASN.1 implementations (asn1c and rasn), and fixes some existing issue with VUPER (like fragmentation).  
